...
BLOG_AUTHOR = "chensy"
BLOG_TITLE = "chensy's blog"
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://chensy0203.github.com"
# This is the URL where nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://nikola.ralsina.com.ar"
BLOG_EMAIL = "chensy0203@163.com"
BLOG_DESCRIPTION = "chensy's blog"
...
# What is the default language? 默认生成的语言
DEFAULT_LANG = "zh_cn"
...
TRANSLATIONS = {
    ...
    # "es": "./es",如果只有一种语言就翻译的语言就设置为空串，不然所有页面都需要带上语言前缀
}
...
GZIP_EXTENSIONS = ('.htm', '.html', '.css', '.js', '.json')
...
# external resources. 设置 true也没有用
USE_CDN = False
